...
void init_arcane_blast(Skill *arcane_blast){
...
void init_cutlass_slash(Skill *cutlass_slash){
...
void init_thorny_veil(Skill *thorny_veil){
...
//special
void init_vine_bind(Skill *vine_bind ){
...
void init_flame_burst(Skill *flame_burst){
...
void init_healing_wave(Skill *healing_wave){
